      ...
      <div class="modal-body">
        <form id="registerForm" name="registerForm" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="password" class="form-control" id="password2" name="password" autocomplete="off" placeholder="Escolha uma senha" required>
          </div>
          <button type="submit" class="btn btn-danger btn-register">Cadastrar</button>
        </form>
      </div>
    </div>
  </div>
